...
import { OceanStationEntity } from '../Assets/OceanStation/OceanStationEntity.js';
import { OceanBuoyEntity } from '../Assets/OceanBuoy/OceanBuoyEntity.js';
...
function main() {
  ...
  // Ocean Station
  let OceanSt = new OceanStationEntity(scene);

  // Ocean Buoy
  let buoyEntity = new OceanBuoyEntity(scene);
