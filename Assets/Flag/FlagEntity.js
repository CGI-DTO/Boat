...
import { FlagBehavior } from '/Ocean/Assets/Flag/FlagBehavior.js'
...
class FlagEntity {
  ...
  constructor(scene, onload){
    ...
    gltfLoader.load('/Ocean/Assets/Flag/flag.glb', (gltf) => {
      // GLTF scene
  ...
  setFlagBeaufortColor(windInt){
    ...
    if (this.beaufortTextures[scale] == undefined){
      ...
      texture = loader.load('/Ocean/Assets/Flag/BeaufortScale/'+ scale +'.png');
