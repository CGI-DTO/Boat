...
import { FlagBehavior } from '/Boat/Assets/Flag/FlagBehavior.js'
...
class FlagEntity {
  ...
  constructor(scene, onload){
    ...
    gltfLoader.load('/Boat/Assets/Flag/flag.glb', (gltf) => {
      // GLTF scene
  ...
  setFlagBeaufortColor(windInt){
    ...
    if (this.beaufortTextures[scale] == undefined){
      ...
      texture = loader.load('/Boat/Assets/Flag/BeaufortScale/'+ scale +'.png');
