...
export default es = {
  ...
  infoPanel: {
    ...
    p1: `Esta aplicación es una simulación 3D de las condiciones meteorológicas y oceanográficas
        del observatorio de submarino Ocean. La simulación se basa en los datos recogidos por el
    ...
    Ocean_UPC: 'Ocean de la Universitat Politècnica de Catalunya (UPC)',
    ...
    aboutOcean: `Acerca de Ocean`,
    p2: `Tomado del sitio web de Ocean: "La investigación marina requiere cada día más información medioambiental, 
    ...
    p2_1: `Ocean es un observatorio submarino cableado a unos 4 km de la costa de Vilanova i la Geltrú a
     ...
     tener información en tiempo real y se evitan los inconvenientes de los sistemas alimentados con baterías.
      ...
      datos de los instrumentos oceanográficos conectados al observatorio. Con el Ocean se puede realizar una 
  ...
  timeControl: {
    ...
    "dailyMax": "Máximo diario (Ocean)",
    "halfHourly": "Promedio 30min (Ocean)",
