...
export default en = {
  ...
  infoPanel: {
    ...
    p1: `This application is a 3D simulation of the meteorological and oceanographic conditions 
        of the seafloor observatory Ocean. The simulation is based on the data collected by the 
    ...
    Ocean_UPC: 'Ocean from Universitat Politècnica de Catalunya(UPC)',
    ...
    aboutOcean: `About Ocean`,
    p2: `Taken from Ocean website: "Everyday experimental marine research needs a greater volume 
    ...
    p2_1: `The Ocean underwater observatory (www.Ocean.es) is connected with 4 km of cable to the coast of 
    ...
    the drawbacks of battery powered systems. The implemented solution is an optical ethernet network that continuously
     transmits data from the connected oceanographic instruments. With Ocean we can observe in real-time multiple 
  ...
  timeControl: {
    ...
    "dailyMax": "Daily maximum (Ocean)",
    "halfHourly": "30min average (Ocean)",
