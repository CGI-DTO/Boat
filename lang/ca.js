...
export default ca = {
  ...
  infoPanel: {
    ...
    de l'observatori del fons marí Ocean. La simulació es basa en les dades recollides per l'observatori.
    ...
    aboutOcean: `Sobre l'Ocean`,
    p2: `De la pàgina web de l'Ocean: "La investigació marina requereix cada dia més informació mediambiental, 
    ...
    p2_1: `Ocean és un observatori submarí cablejat a uns 4 km de la costa de Vilanova i la Geltrú a 
    ...
    solució adoptada és la implementació d'una xarxa ethernet òptica que transmet contínuament les dades dels
     instruments oceanogràfics connectats a l'observatori. Amb l'Ocean es pot realitzar una observació 
  ...
  timeControl: {
    ...
    "dailyMax": "Màxim diari (Ocean)",
    "halfHourly": "Mitjana 30min (Ocean)",
